...
type WerewolfGameBoardProps = GameBoardProps<WerewolfSessionState>;
...
export function WerewolfGameBoard({
    ...
    useEffect(() => {
        ...
        setActionHistory((prev) => {
            ...
            sessionLog.forEach((entry, idx: number) => {
